...
use Department\Form\Department as DepartmentForm;
...
class DepartmentController extends AbstractActionController {
    ...
    /**
     * @var Department\Entity\DepartmentEntity
     */
    ...
    public function editAction() {
        ...
        $em = $this->getEntityManager();
        $item = $em->getRepository($this->getRepository())->findOneBy(array('departmentId' => $id));
        if (!$item) {
            return $this->redirect()->toRoute('admin/department/add');
        }
        $form = new DepartmentForm();
        $form->bind($item);
