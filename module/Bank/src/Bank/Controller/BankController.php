...
use Bank\Form\Bank as BankForm;
...
class BankController extends AbstractActionController {
    ...
    public function editAction() {
        ...
        $em = $this->getEntityManager();
        $item = $em->getRepository($this->getRepository())->findOneBy(array('bankId' => $id));
        if (!$item) {
            return $this->redirect()->toRoute('admin/bank/add');
        }
        $form = new BankForm($this->getEntityManager());
        $form->bind($item);
