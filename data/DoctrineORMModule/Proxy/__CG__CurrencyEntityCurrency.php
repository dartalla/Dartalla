...
namespace DoctrineORMModule\Proxy\__CG__\Currency\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Currency extends \Currency\Entity\Currency implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'currencyId', 'currencyName');
        }
    ...
    public function getCurrencyId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getCurrencyId();
        }
